...
public final class NotificationActionData {
    ...
    @SuppressLint("PrivateResource") // we currently use Media3's internal strings and icons
    @Nullable
            ...
            case NotificationConstants.SMART_REWIND_PREVIOUS:
                if (player.getPlayQueue() != null && player.getPlayQueue().size() > 1) {
                    ...
                    return new NotificationActionData(ACTION_FAST_REWIND,
                            ...
                            androidx.media3.ui.R.drawable.exo_legacy_controls_rewind);
                }
            ...
            case NotificationConstants.SMART_FORWARD_NEXT:
                if (player.getPlayQueue() != null && player.getPlayQueue().size() > 1) {
                    ...
                    return new NotificationActionData(ACTION_FAST_FORWARD,
                            ...
                            androidx.media3.ui.R.drawable.exo_legacy_controls_fastforward);
                }
            ...
            case NotificationConstants.SHUFFLE:
                if (player.getPlayQueue() != null && player.getPlayQueue().isShuffled()) {
                    ...
                    return new NotificationActionData(ACTION_SHUFFLE,
                            ...
                            androidx.media3.ui.R.drawable.exo_legacy_controls_shuffle_off);
                }
