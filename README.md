...
- Optionally sync the high-confidence AiSList blocklist directly from its upstream project and hide
  listed YouTube channels locally without sending the viewed video or channel to a detection service
