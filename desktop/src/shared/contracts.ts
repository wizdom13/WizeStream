...
export interface PreviewFrameset {
  urls: string[];
  frameWidth: number;
  frameHeight: number;
  totalCount: number;
...
export type PreferredOpenAction = 'details' | 'play' | 'enqueue';

export interface ChannelPlaybackProfile {
  videoResolution?: string;
  videoFormat?: string;
  audioTrackId?: string;
  audioLocale?: string;
  subtitleLanguageTag?: string | null;
  speed?: number;
  updatedAt: number;
}
...
export interface DesktopSettings {
  ...
  autoQueueRelated: boolean;
  clearQueueConfirmation: boolean;
  seekDurationSeconds: 5 | 10 | 15 | 30 | 60;
  useInexactSeek: boolean;
  startPlayerFullscreen: boolean;
  preferredOpenAction: PreferredOpenAction;
  perChannelPlaybackProfiles: boolean;
  rememberLiveStreamSpeed: boolean;
  channelPlaybackProfiles: Record<string, ChannelPlaybackProfile>;
