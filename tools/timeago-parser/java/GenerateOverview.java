...
public class GenerateOverview {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (String unitName : Arrays.asList("seconds", "minutes", "hours", "days", "weeks", "months", "years")) {
            JsonObject object = JsonParser.object().from(new FileInputStream(
                    new File("tools/timeago-parser/times/" + unitName + ".json")));
        ...
        writeMapTo(outMap, JsonWriter.indent("  ").on(new FileOutputStream(
                new File("tools/timeago-parser/overview.json"))));
    }
